...
class Ui_SetupDialog(object):
    def setupUi(self, SetupDialog):
        ...
        self.pushButtonDropboxPathCalcel = QtWidgets.QPushButton(self.dropboxPathPageButtons)
        icon = QtGui.QIcon.fromTheme("dialog-close")
        self.pushButtonDropboxPathCalcel.setIcon(icon)
        self.pushButtonDropboxPathCalcel.setObjectName("pushButtonDropboxPathCalcel")
        self.gridLayout_8.addWidget(self.pushButtonDropboxPathCalcel, 0, 3, 1, 1)
        ...
        SetupDialog.setTabOrder(self.pushButtonDropboxPathSelect, self.pushButtonDropboxPathCalcel)
        SetupDialog.setTabOrder(self.pushButtonDropboxPathCalcel, self.pushButtonDropboxPathUnlink)
    ...
    def retranslateUi(self, SetupDialog):
        ...
        self.pushButtonDropboxPathCalcel.setText(_translate("SetupDialog", "Cancel"))
